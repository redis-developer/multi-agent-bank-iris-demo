...
| 1:15–1:45 | 4 Multi-agent | Observe-the-code section (one-line edit only): read personas → tool loop → supervisor → wiring, then test. Toolbox = permission model; the CUST1002 NOC refusal (step 6); a chat that mutates Redis (step 7) |
